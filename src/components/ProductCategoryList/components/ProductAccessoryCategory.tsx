...
const ProductAccessoryCategory: React.FC<Props> = ({ handleNavigate }) => {
    ...
    const fetchProducts = async () => {
        productService.getArrivalByCategory(5)
            .then((resp) => {
                        ...
                        <div className="title-2 mb-30">
                            <div className="title-box">
                                ...
                                <div className="cr-banner-sub-title">
                                    <p>Những sản pẩm phụ kiện độc đáo .</p>
                                </div>
                            </div>
...
export default ProductAccessoryCategory;
