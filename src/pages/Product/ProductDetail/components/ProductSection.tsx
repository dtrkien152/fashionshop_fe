    ...
    return (
        <section className="section-product padding-t-100">
            <div className="container">
                    ...
                    <div className="col-xxl-8 col-xl-7 col-md-6 col-12 mb-24">
                        ...
                        <div className="cr-size-and-weight">
                            <div className="cr-review-star">
                                <RatingStars rating={props.products?.averageRating || 0}/>
                            ...
                            <div className="list">
                                <ul style={{marginBottom: 20}}>
                                    ...
                                    <li>
                                        ...
                                        {props.products?.category_name}
                                    </li>
                                    <li>
                                        <label>
                                            Giới tính <span>:</span>
                                        </label>
                                        {convertGender(props.products?.gender)}
                                    </li>

                                    <li>
                                        <label style={{display: 'block', marginBottom: 4}}>
                                            Thông tin khác <span>:</span>
                                        </label>
                                        <div
                                    ...
                                    <li>
                                        <label>
                                            Số lượng có sẵn <span>:</span>
                                        </label>
                                        {props.products?.totalAvailable}
                                    </li>
                                </ul>
                            </div>
                ...
                <TabComponent products={props.products} />
            </div>
        </section>
    );
};
