              ...
              <div className="cr-product-card">
                <div className="cr-product-image">
                  ...
                  <div className="cr-side-view">
                    <a href="#" className="wishlist"><i className="ri-heart-line"></i></a>
                    <a className="model-oraganic-product" data-bs-toggle="modal" href="#quickview" role="button"><i className="ri-eye-line"></i></a>
                  </div>
                  <a className="cr-shopping-bag" href="#"><i className="ri-shopping-bag-line"></i></a>
                </div>
                <div className="cr-product-details">
                  ...
                  <a href="product-left-sidebar.html" className="title">{product.title}</a>
                  <p className="cr-price"><span className="new-price">{product.newPrice}</span> <span className="old-price">{product.oldPrice}</span></p>
                </div>
              </div>
            </SwiperSlide>
          ))}
