  ...
  return (
    <section className="section-shop padding-tb-100">
      <div className="container">
        ...
        <div className="row">
          <div className="col-12" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="600">
            <div className="row">
                ...
                <div className="cr-product-card">
                  <div className="cr-product-image">
                    ...
                    <div className="cr-side-view">
                      ...
                      <a className="model-oraganic-product" data-bs-toggle="modal" href="#quickview"
                         role="button">
                  ...
                  <div className="cr-product-details">
                    ...
                    <p className="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                      ...
                      ut labore lacus vel facilisis.</p>
                    <p className="cr-price"><span className="new-price">$120.25</span> <span
                      className="old-price">$123.25</span></p>
                  </div>
                </div>
              </div>
              <div className="col-lg-3 col-6 cr-product-box mb-24">
                <div className="cr-product-card">
                  ...
                  <div className="cr-product-details">
                    ...
                    <p className="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                      eiusmod tempor incididunt
                      ut labore lacus vel facilisis.</p>
                    <p className="cr-price"><span className="new-price">$145</span> <span
                      className="old-price">$150</span></p>
                  </div>
                </div>
              </div>
              <div className="col-lg-3 col-6 cr-product-box mb-24">
                ...
                <div className="cr-product-card">
                  ...
                  <div className="cr-product-details">
                    ...
                    <p className="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                      eiusmod tempor incididunt
                      ut labore lacus vel facilisis.</p>
                    <p className="cr-price"><span className="new-price">$50.30</span> <span
                      className="old-price">$72.60</span></p>
                  </div>
                </div>
              </div>
              <div className="col-lg-3 col-6 cr-product-box mb-24">
                ...
                <div className="cr-product-card">
                  ...
                  <div className="cr-product-details">
                    ...
                    <p className="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                      eiusmod tempor incididunt
                      ut labore lacus vel facilisis.</p>
                    <p className="cr-price"><span className="new-price">$20</span> <span
                      className="old-price">$22.10</span></p>
                  </div>
                </div>
              </div>
              <div className="col-lg-3 col-6 cr-product-box mb-24">
