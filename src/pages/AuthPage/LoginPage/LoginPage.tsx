...
import {login, logout} from '~/shared/reducers/authReducer';
                    ...
                    <label htmlFor="rememberMe">Remember Me</label>
                                ...
                                <div className="login-buttons">
                                    <div style={{display:"flex"}}>
                                        <button type="button" className="cr-button" onClick={handleLogin} style={{marginRight:20,width:120}}>
                                            Đăng nhập
                                        </button>
